...
/**
 * Classe base per a totes les implementacions d'algoritmes de parell més proper en 3D.
 * <p>
 * Proporciona funcionalitat comuna per a tots els algoritmes que calculen el parell més proper
 * entre punts tridimensionals, incloent el càlcul de distàncies i un mètode de força bruta per a
 ...
 * @version 1.0
 */
public abstract class ClosestPairBase3D implements ClosestPairAlgorithmStrategy<Point3D> {

    /**
     * Retorna la dimensió en què opera aquest algoritme (sempre 3D).
     * 
     * @return la dimensió tridimensional
     */
    @Override
    ...
    /**
     * Calcula la distància euclidiana entre dos punts 3D.
     * <p>
     * Utilitza la fórmula: sqrt(dx² + dy² + dz²).
     * </p>
     * 
    ...
    /**
     * Algoritme de força bruta per trobar el parell més proper entre un conjunt petit de punts en 3D.
     * <p>
     ...
     */
    protected AlgorithmResult<Point3D> bruteForce(Point3D[] points, int left, int right, long startTime) {
